  ...
  return (
    <main className="relative max-h-screen">
      ...
      <div className={`  pt-2  relative  transition-all ${contentOffset}`}>
        <div className="sticky top-14 md:top-0 z-10 px-5 bg-white  md:container mx-auto ">
           <div id="admin-header" />
        </div>
        <div className="px-4  md:px-5 pb-10 pt-14 md:pt-0 md:container mx-auto relative">
          <Outlet />
        </div>
      </div>
    </main>
